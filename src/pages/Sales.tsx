            ...
            <Table>
              ...
              <TableBody>
                {filtered.length === 0 ? (
                  ...
                  <TableRow key={inv.id} className="cursor-pointer hover:bg-muted/50" onClick={() => navigate(`/sales/${inv.id}`)}>
                    ...
                    <TableCell>
                      <Button variant="ghost" size="icon" onClick={e => { e.stopPropagation(); navigate(`/sales/${inv.id}`); }}>
